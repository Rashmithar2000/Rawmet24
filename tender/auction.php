 ...
 <h2 style="color: #7e828b;">AUCTIONS</h2> </center>
    ...
    <div class="col-sm-12 col-md-3">
            ...
            <center><button style="padding:5px ;border-color: #0c0c0c; border-radius: 20px; color: #333131; margin-top:20px;"><?php echo $daysToGo . ' ' . $daysText . $status;?></button>
                  <div class="" style="padding:12px ;border-color: #0c0c0c;  color: #333131;margin-top:20px; "><h4>Bid Before: <?php echo $row['endDatetime']; ?> </h4><h3>Quantity: <?php echo $row['quantity']; ?><br>Approx. business: ₹<?php echo $row['aucValue']; ?></h3></div></center>
