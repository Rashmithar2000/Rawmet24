...
<td style="padding: 0px;">
  <div style="display: flex; gap: 5px;">
    <form action="fetchCat.php?g=<?php echo $row['id'];?>" method="GET">
      ...
      <button class="btn btn-block btn-sm btn-gradient-primary mt-4 mx-auto" type="submit" style="width:auto;margin-bottom:22px">
        <a href="fetchCat.php?id=<?php echo $row['id']; ?>"><i class="fa fa-solid fa-pen"></i></a>
      </button>
    </form>
    <form action="deleteCat.php?g=<?php echo $row['id'];?>" method="POST">
      <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
      <button class="btn btn-block btn-sm btn-gradient-danger mt-4 mx-auto" type="submit">
        <a href="deleteCat.php?id=<?php echo $row['id']; ?>"><i class="fa fa-solid fa-trash"></i></a>
      </button>
    </form>
  </div>
</td>
