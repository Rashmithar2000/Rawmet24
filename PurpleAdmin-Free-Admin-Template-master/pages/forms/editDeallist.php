      ...
      <tr>
        ...
        <td><?php echo $row['material']; ?></td>
                <td style="padding: 0px;"> <div style="display: flex; gap: 5px;">
                  <form action="fetchDeal.php?g=<?php echo $row['id'];?>" method="GET">
                ...
                <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
                <button class="btn btn-block btn-sm btn-gradient-danger mt-4 mx-auto" type="submit" ><a href="deleteDeal.php? id='.$id.'"><i class="fa fa-solid fa-trash"></i></a> </button>
                </form></div>
              </td>
      </tr>
    <?php } ?>
